      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="relative h-screen flex items-center justify-center text-center bg-blue-100">
          ...
          <div className="relative z-10 px-6">
            ...
            <p className="text-lg mb-6">أفضل خدمات طب الأسنان بأحدث التقنيات</p>
        ...
        <section className="py-16 px-6 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">خدماتنا</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 shadow-lg rounded-2xl hover:scale-105 transition">
              <h3 className="text-xl font-semibold mb-2">
                <img
                  src="https://cdn-icons-png.flaticon.com/128/3240/3240139.png "
                  alt="Tooth Brush"
            ...
            <div className="p-6 shadow-lg rounded-2xl hover:scale-105 transition">
              <h3 className="text-xl font-semibold mb-2">
                <img
                  src="https://cdn-icons-png.flaticon.com/128/16405/16405926.png"
                  alt="Tooth Brush"
                  className="w-6 h-6 inline-block mr-2"
                />
                تبييض الأسنان
            ...
            <div className="p-6 shadow-lg rounded-2xl hover:scale-105 transition">
              <h3 className="text-xl font-semibold mb-2">
                <img
                  src="https://cdn-icons-png.flaticon.com/128/3240/3240102.png"
                  alt="Tooth Brush"
                  className="w-6 h-6 inline-block mr-2"
                />
                زراعة الأسنان
        ...
        <section className="bg-gray-100 py-16 px-6">
          <h2 className="text-3xl font-bold text-center mb-10">آراء المرضى</h2>
